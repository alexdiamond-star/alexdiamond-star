...
I work as an Economics Research Assistant in Reed College's Economics Department under Dr. Felipe Carrera, with the goal of producing a published paper. This research is a continuation of my Economics Research Fellowship (Summer 2025). My work spans:
 
* Constructing and standardizing multi-year datasets from Spanish-language reports for regression analysis
* GIS mapping and spatial analysis of impacted areas
* Researching the long-run economic impact of the Shining Path (*Sendero Luminoso*, PCP-SL) insurgency in Peru
* Conducting literature reviews on the economic consequences of insurgencies
## 🗺️ Projects
 
__[Shining Path Dashboard (PCP-SL)](https://kaishinlin.shinyapps.io/PCP-SL/)__ is an interactive R Shiny dashboard built to support exploratory research into the geographic distribution of conflict exposure and socioeconomic conditions across Peru. The dashboard was developed collaboratively with Kaishin Lin and Dr. Felipe Carrera, and includes:
 
* **Choropleth Map** — Interactive visualization of variables (years of conflict exposure, total deaths, coca suitability, demographic indicators) at district, provincial, and departmental levels
